...
public:
    ...
    void setupUi(QWidget *studentpreexam)
    {
        ...
        exam->setGeometry(QRect(280, 10, 371, 31));
        exam->setFont(font);
        pushButton_2 = new QPushButton(studentpreexam);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(280, 40, 371, 31));
        pushButton_3 = new QPushButton(studentpreexam);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(280, 70, 371, 31));
        label = new QLabel(studentpreexam);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(110, 50, 101, 31));
        Return = new QPushButton(studentpreexam);
        Return->setObjectName(QStringLiteral("Return"));
        Return->setGeometry(QRect(570, 347, 80, 31));
        examList = new QListWidget(studentpreexam);
        examList->setObjectName(QStringLiteral("examList"));
        examList->setGeometry(QRect(10, 100, 641, 221));
        refresh = new QPushButton(studentpreexam);
        refresh->setObjectName(QStringLiteral("refresh"));
        refresh->setGeometry(QRect(30, 330, 80, 31));
    ...
    void retranslateUi(QWidget *studentpreexam)
    {
        ...
        refresh->setText(QApplication::translate("studentpreexam", "\345\210\267\346\226\260", Q_NULLPTR));
    } // retranslateUi
