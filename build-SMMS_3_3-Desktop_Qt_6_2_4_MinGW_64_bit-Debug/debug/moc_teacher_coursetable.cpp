...
#include <memory>
#include "../../manage/teacher_coursetable.h"
...
struct qt_meta_stringdata_teacher_courseTable_t {
    const uint offsetsAndSize[2];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_teacher_courseTable_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_teacher_courseTable_t qt_meta_stringdata_teacher_courseTable = {
    {
...
static const uint qt_meta_data_teacher_courseTable[] = {
...
const QMetaObject teacher_courseTable::staticMetaObject = { {
    QMetaObject::SuperData::link<courseTable::staticMetaObject>(),
    qt_meta_stringdata_teacher_courseTable.offsetsAndSize,
    qt_meta_data_teacher_courseTable,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_teacher_courseTable_t
...
void *teacher_courseTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_teacher_courseTable.stringdata0))
