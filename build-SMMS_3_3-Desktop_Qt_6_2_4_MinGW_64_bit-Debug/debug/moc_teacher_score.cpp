...
#include <memory>
#include "../../manage/teacher_score.h"
...
struct qt_meta_stringdata_teacher_score_t {
    const uint offsetsAndSize[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_teacher_score_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_teacher_score_t qt_meta_stringdata_teacher_score = {
    {
...
static const uint qt_meta_data_teacher_score[] = {
...
const QMetaObject teacher_score::staticMetaObject = { {
    QMetaObject::SuperData::link<teacher::staticMetaObject>(),
    qt_meta_stringdata_teacher_score.offsetsAndSize,
    qt_meta_data_teacher_score,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_teacher_score_t
...
void *teacher_score::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_teacher_score.stringdata0))
